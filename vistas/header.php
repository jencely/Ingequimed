    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo" >
          ...
          <span class="logo-mini"><b>CEMOPLAF</b></span>
          
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>CEMOPLAF</b></span>
        </a>
        ...
        <section class="sidebar">       
          ...
          <ul class="sidebar-menu">
            ...
            if ($_SESSION['triaje']==1)
            {
              echo '<li>
              <a href="triaje.php">
                <i class=""></i> <span>protocolo de intervencion</span>
              </a>
            </li>';
            }
            ?>
